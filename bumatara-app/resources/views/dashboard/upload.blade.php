...
<ul class="nav nav-pills mb-4" id="uploadTab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="video-tab" data-bs-toggle="pill" data-bs-target="#panel-video" type="button"
            role="tab"><i class="bi bi-youtube me-2"></i>Video Edukasi</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="code-tab" data-bs-toggle="pill" data-bs-target="#panel-code" type="button"
            role="tab"><i class="bi bi-file-earmark-code me-2"></i>Source Code & Model
            AI</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="product-tab" data-bs-toggle="pill" data-bs-target="#panel-product" type="button"
            role="tab"><i class="bi bi-images me-2"></i>Foto Produk</button>
    </li>
</ul>
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control"
                                placeholder="Contoh: Implementasi Real-Time Video Detection YOLOv5" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" required>
                                ...
                                <option value="{{$row -> value}}">{{$row -> content}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Contoh: Plat Nomor Detection System"
                                required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-12">
                        ...
                        <button type="submit" class="btn btn-submit"><i class="bi bi-cloud-arrow-up me-2"></i>Upload
                            Aset AI</button>
                    </div>
                </div>
            </form>
        ...
        <div class="upload-card p-4">
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-submit mt-2"><i class="bi bi-image-fill me-2"></i>Simpan
                            Gambar Produk</button>
                    </div>
                </div>
            </form>
        </div>
